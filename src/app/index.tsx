...
const steps = [
  { number: "01", title: "Choose two skills", detail: "One for work. One for life." },
  { number: "02", title: "Take one clear step", detail: "A mission that fits your time." },
  { number: "03", title: "See real progress", detail: "Show your work and learn from it." },
];
  ...
  return <SafeAreaView style={styles.page}>
    ...
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <View style={styles.card}>
        ...
        <Text style={styles.eyebrow}>SMALL STEPS. REAL GROWTH.</Text>
        <Text accessibilityRole="header" style={styles.title}>One small win, every day.</Text>
        <Text style={styles.subtitle}>Pick a career skill and a life skill. Get a clear mission for your time, then see what you’ve improved.</Text>
...
const styles = StyleSheet.create({
  ...
  card:{backgroundColor:"#071B16",borderWidth:1,borderColor:"#29483B",borderRadius:28,padding:24},brandRow:{flexDirection:"row",alignItems:"center",marginBottom:24},brandMark:{width:36,height:36,borderRadius:11,backgroundColor:"#7AF5B8",alignItems:"center",justifyContent:"center"},brandLetter:{color:"#010807",fontSize:18,fontWeight:"900"},logo:{color:"#F5FFF9",fontSize:17,fontWeight:"900",letterSpacing:3,marginLeft:10},beta:{color:"#9FC3AF",fontSize:9,fontWeight:"800",letterSpacing:1,marginLeft:9,borderWidth:1,borderColor:"#315544",borderRadius:6,paddingHorizontal:7,paddingVertical:4},
  eyebrow:{color:"#7AF5B8",fontSize:10,fontWeight:"900",letterSpacing:1.4},title:{color:"#F5FFF9",fontSize:37,lineHeight:43,fontWeight:"800",letterSpacing:-.8,marginTop:12},subtitle:{color:"#C8EED9",fontSize:15,lineHeight:23,marginTop:13},
  steps:{backgroundColor:"#0B251B",borderRadius:17,borderWidth:1,borderColor:"#1E3A31",paddingHorizontal:15,marginTop:24,marginBottom:20},step:{flexDirection:"row",alignItems:"center",paddingVertical:12},stepBorder:{borderTopWidth:1,borderTopColor:"#1E3A31"},stepNumber:{color:"#7AF5B8",fontSize:11,fontWeight:"900",width:33},stepBody:{flex:1},stepTitle:{color:"#F5FFF9",fontSize:13,fontWeight:"800"},stepDetail:{color:"#A7CBB7",fontSize:11,lineHeight:16,marginTop:2},
