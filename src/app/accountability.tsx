...
export default function AccountabilityScreen() {
  ...
  const existingAccountability =
    typeof params.accountability === "string"
      ? params.accountability
      : "";

  const [selected, setSelected] = useState(existingAccountability);

  const continueNext = async (choice = selected) => {
    await updateProfile({ accountability: choice || undefined });
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.progress}>04 / 05</Text>

        <Text style={styles.title}>
          How do you want to stay
          <Text style={styles.green}> accountable?</Text>
        </Text>
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoTitle}>Choose your support style</Text>

          <Text style={styles.infoText}>
            The right accountability system makes consistency feel easier and
            more automatic.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  skipText: { color: "#8FB6A2", fontSize: 13, fontWeight: "700" },
